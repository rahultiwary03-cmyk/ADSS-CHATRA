...
# --- Updated Header with "Social Security Office" ---
st.markdown("""
    <div class="header-container">
        <h1 style='font-size: 2.8rem; margin-bottom: 5px;'>झारखण्ड मुख्यमंत्री मईयां सम्मान योजना (JMMMSY)</h1>
        <h3 style='font-weight: normal; margin-top: 0; opacity: 0.9;'>
            सामाजिक सुरक्षा कार्यालय, चतरा
        </h3>
    ...
    if aadhar_input:
        with st.spinner('डेटा खोजा जा रहा है...'):
            ...
            if not result.empty:
                ...
                status_color = "#06d6a0" if "Success" in status else "#ef476f"
...
st.markdown("""
    <div style='text-align: center; color: #666; border-top: 1px solid #ddd; padding-top: 20px;'>
        <p>© 2026 <b>सामाजिक सुरक्षा कार्यालय, चतरा</b> | तकनीकी सेल</p>
    </div>
    """, unsafe_allow_html=True)
